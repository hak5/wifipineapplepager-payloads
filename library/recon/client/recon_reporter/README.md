...
```bash
scp -r library/recon/client/recon_reporter root@172.16.42.1:/root/payloads/recon/client/
chmod +x /root/payloads/recon/client/recon_reporter/payload
```

## Configuration

Edit `/root/payloads/recon/client/recon_reporter/payload`:
