#!/bin/bash
# Title: Device Hunter - Targeted Payload (Nut Hunter)
# Description: targeted payload - Auto-hunt selected AP from Recon search.
# Author: RocketGod + Sidekick - Notorious Squirrel
