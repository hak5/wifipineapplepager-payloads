...
run_commander() {
    ...
    while true; do
        # Show menu - PROMPT + NUMBER_PICKER pattern
        PROMPT "EINHERJAR Commands:
...
Press OK then enter number."
        ...
        local choice=$(NUMBER_PICKER "Command (1-7)" 1)
        case $? in
...
LOG ""
LOG " ___ ___ _  _ _  _ ___ ___    _  _   ___ "
LOG "| __|_ _| \\| | || | __| _ \\_ | |/_\\ | _ \\"
LOG "| _| | || .' | __ | _||   / || / _ \\|   /"
LOG "|___|___|_|\\_|_||_|___|_|_\\\\__/_/ \\_\\_|_\\"
LOG ""
...
2. Commander (Lead the swarm)
3. Warrior (Join a swarm)
